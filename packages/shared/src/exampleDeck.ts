...
const cards: Card[] = [
  ...
  },
  {
    ...
    imageUrl: "https://picsum.photos/seed/tindeuro-baskets/800/600",
  },
  {
    id: "essai-streaming",
    kind: "decision",
  ...
  },
  {
    ...
    visibility: "range",
    tags: ["pression-sociale"],
    imageUrl: "https://picsum.photos/seed/tindeuro-baskets-fils/800/600",
  },
  {
    id: "carte-fidelite",
    kind: "decision",
  ...
  },
  {
    ...
    category: "Imprévus",
    tags: ["imprevu"],
    imageUrl: "https://picsum.photos/seed/tindeuro-machine-a-laver/800/600",
  },
  {
    id: "pneu-creve",
    kind: "event",
...
export const exampleDeckCategories = [
  "Alimentation",
  "Sorties & social",
  "Enfants & famille",
  "Maison",
...
export const exampleDeck: Deck = {
  ...
  shuffle: false,
  categories: [...exampleDeckCategories],
  cards,
};

/** @deprecated Utiliser `exampleDeckCategories` ou `deck.categories`. */
export const suggestedCategories = exampleDeckCategories;
